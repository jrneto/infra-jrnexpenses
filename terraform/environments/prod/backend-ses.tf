...
# Só fica "success" depois que o record TXT de verificação
# (backend-dns.tf) propagar — mesmo princípio do
# aws_acm_certificate_validation já usado no certificado de hom
# (FEAT-12).
