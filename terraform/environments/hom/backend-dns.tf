...
# jrnexpenses.com. (gerenciada pelo Terraform deste repositório,
# terraform/dns/). Referenciada aqui só por leitura (data source, por
# nome), sem duplicar ou gerenciar a zona em si — mesmo padrão já usado
# por api.jrnexpenses.com em produção (FEAT-12).
...
# Verificação de domínio e DKIM da identidade SES (backend-ses.tf,
# FEAT-33) — mesmos princípios acima: records na zona deste
# repositório, referenciada só por leitura.
