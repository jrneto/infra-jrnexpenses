...
# referencia o recurso ao vivo porque a AWS devolve esse atributo com
# encoding MIME (RFC 2047) sempre que o texto tem acentuação, diferente
# do literal do .tf; isso gera diff perpétuo nesse atributo (bug de
# idempotência do provider) e, pior, arrastaria
...
# Descoberto ao aplicar em hom (FEAT-36); drift confirmado de novo na
# baseline da FEAT-40 (backend/specs/FEAT-40-extracao-infra-repo-apartado/).
